...
from runner.helpers.collections import group_text, handle_tags, pretty_print_messages
import runner.settings as sts
import runner.helpers.collections as hlp
import runner.test.testhelper as helpers
import logging
...
class Test_Unittest(unittest.TestCase):
    ...
    def setUpClass(cls, *args, **kwargs):
        ...
        cls.assist_text = """
            Certainly! To create your package named `myclock` in your user directory, run the following command in your terminal:  ```shell pipenv run bgr clone -pr 'myclock' -n 'myclock' -a 'myclk' -t 'C:\\Users\\lars' -p 3.11 --install ```  \nThis will clone `bg_runner` to `C:/Users/lars/myclock`, set up the environment, and install dependencies.
        """
